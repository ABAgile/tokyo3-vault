...
type Issuer interface {
	Issue(ctx context.Context, kp bcrypto.KeyProvider, backend *model.DynamicBackend, role *model.DynamicRole, ttl time.Duration) (username, password string, expiresAt time.Time, err error)
	Revoke(ctx context.Context, kp bcrypto.KeyProvider, backend *model.DynamicBackend, revocationTmpl, username string) error
}
